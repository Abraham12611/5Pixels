...
const variantClasses = {
  ...
  warning: "border-warning/30 bg-charcoal-850",
  danger: "border-error/30 bg-charcoal-850",
};
...
export function StatCard({
  ...
  return (
    ...
    >
      ...
      <p className="text-cream-50 mt-2 text-3xl font-bold tabular-nums tracking-tight">
        {value}
      </p>
